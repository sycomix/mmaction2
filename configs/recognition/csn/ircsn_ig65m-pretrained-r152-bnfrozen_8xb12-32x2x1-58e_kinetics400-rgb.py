...
data_root = f'{root}videos_train'
data_root_val = f'{root}videos_val'
data_root_test = data_root_val

ann_file_train = f'{root}kinetics400_train_list_videos.txt'
ann_file_val = f'{root}kinetics400_val_list_videos.txt'
